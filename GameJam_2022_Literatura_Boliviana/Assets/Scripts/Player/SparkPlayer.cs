...
//     version 1.3.0
//     from Assets/Scripts/MusicPuzzleManager/SparkPlayer.inputactions
//
...
public partial class @SparkPlayer : IInputActionCollection2, IDisposable
{
    ...
    {
        private @SparkPlayer m_Wrapper;
        public UIActions(@SparkPlayer wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @SparkPlayer m_Wrapper;
        public PlayerActions(@SparkPlayer wrapper) { m_Wrapper = wrapper; }
